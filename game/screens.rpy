...
style bar:
    ysize gui.bar_size
    left_bar Frame("bar_left", gui.bar_borders, tile=gui.bar_tile)
    right_bar Frame("bar_right", gui.bar_borders, tile=gui.bar_tile)

style vbar:
    xsize gui.bar_size
    top_bar Frame("bar_top", gui.vbar_borders, tile=gui.bar_tile)
    bottom_bar Frame("bar_bottom", gui.vbar_borders, tile=gui.bar_tile)
...
style frame:
    ...
    background Frame("frame", gui.frame_borders, tile=gui.frame_tile)
...
style radio_button:
    ...
    foreground "button_radio_[prefix_]foreground"
...
style check_button:
    ...
    foreground "button_check_[prefix_]foreground"
...
style confirm_frame:
    background Frame([ "frame"], gui.confirm_frame_borders, tile=gui.frame_tile)
